    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-navy mb-12 text-center">{t.aboutPage.story.title}</h2>
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-navy mb-16 text-center">{t.aboutPage.mission.title}</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-md transition-all duration-300 hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-navy mb-4">{t.aboutPage.mission.missionTitle}</h3>
            ...
            <div className="bg-white rounded-2xl p-10 shadow-md transition-all duration-300 hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-navy mb-4">{t.aboutPage.mission.accessibility}</h3>
              <p className="text-gray text-base leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-md transition-all duration-300 hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-navy mb-4">{t.aboutPage.mission.quality}</h3>
              <p className="text-gray text-base leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-md transition-all duration-300 hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-navy mb-4">{t.aboutPage.mission.personalization}</h3>
              <p className="text-gray text-base leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-md transition-all duration-300 hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-navy mb-4">{t.aboutPage.mission.community}</h3>
              <p className="text-gray text-base leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-10 shadow-md transition-all duration-300 hover:shadow-xl">
              ...
              <h3 className="text-xl font-bold text-navy mb-4">{t.aboutPage.mission.innovation}</h3>
              <p className="text-gray text-base leading-relaxed">
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-navy text-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-20 text-center">{t.aboutPage.stats.title}</h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-16">
            <div className="text-center">
              <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-mint mb-4">1,000+</div>
              <div className="text-cream text-sm md:text-base lg:text-lg">{t.aboutPage.stats.tutors}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-coral mb-4">10,000+</div>
              <div className="text-cream text-sm md:text-base lg:text-lg">{t.aboutPage.stats.students}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-mint mb-4">120+</div>
              <div className="text-cream text-sm md:text-base lg:text-lg">{t.aboutPage.stats.countries}</div>
            </div>
            <div className="text-center">
              <div className="text-4xl md:text-5xl lg:text-6xl font-bold text-coral mb-4">4.9/5</div>
              <div className="text-cream text-sm md:text-base lg:text-lg">{t.aboutPage.stats.rating}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-navy mb-16 text-center">{t.aboutPage.different.title}</h2>
          ...
          <div className="space-y-12">
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-navy mb-3">{t.aboutPage.different.item1Title}</h3>
                <p className="text-gray text-base leading-relaxed">
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-navy mb-3">{t.aboutPage.different.item2Title}</h3>
                <p className="text-gray text-base leading-relaxed">
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-navy mb-3">{t.aboutPage.different.item3Title}</h3>
                <p className="text-gray text-base leading-relaxed">
            ...
            <div className="flex items-start gap-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-navy mb-3">{t.aboutPage.different.item4Title}</h3>
                <p className="text-gray text-base leading-relaxed">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <Link to="/start-teaching">
              <Button size="lg" variant="outline">{t.aboutPage.cta.tutorButton}</Button>
            </Link>
          </div>
        </div>
      </section>
