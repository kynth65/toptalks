    ...
    <footer className="bg-navy text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          {/* For Students & Tutors */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-white">{t.footer.forUsers}</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  to="/student-services"
          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3" onSubmit={(e) => e.preventDefault()}>
              <input
                ...
                className="flex-1 px-4 py-3 rounded-[1.5rem] bg-white/10 text-white placeholder-cream/50 focus:outline-none focus:ring-2 focus:ring-mint border border-cream/20 transition-all duration-200"
              />
              <button
                type="submit"
                className="px-8 py-3 bg-mint text-navy rounded-[1.5rem] font-medium hover:bg-mint/90 hover:scale-105 transition-all duration-300 shadow-lg"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-16 pt-12 border-t border-cream/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex space-x-6">
              <Link
                to="/facebook"
                className="text-cream/60 hover:text-mint transition-all duration-200 hover:scale-110"
                aria-label="Facebook"
              >
